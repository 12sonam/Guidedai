...
//     if (!itemId || !fullName || !userEmail || !userId || !guestSize || !phone || !bookAt || !price || !website_url) {
//       return res.status(400).json({ 
//         success: false, 
//         message: "Missing required fields: itemId, fullName, userEmail, userId, guestSize, phone, bookAt, price, and website_url are required" 
//       });
//     }
...
//       return_url: `http://localhost:3000/payment/complete-khalti-payment`,
//       website_url,
//     });
...
//       return res.status(400).json({
//         success: false,
//         message: "Missing required query parameters: pidx, transaction_id, amount, and purchase_order_id are required",
//       });
//     }
...
//       { pidx, transactionId: transaction_id }, // Find by pidx and transactionId
//       {
//         $setOnInsert: {
...
// // backend/controllers/initializekhalti.js
// import express from "express";
// import mongoose from "mongoose";
// import { initializeKhaltiPayment, verifyKhaltiPayment } from "./khalti.js";
// import Payment from "../models/paymentmodel.js";
...
//       bookAt,
//       price,
//       originalPrice, // Add originalPrice from request body
//       originalCurrency, // Add originalCurrency from request body
//       website_url,
//     } = req.body;
...
//     guestSize = Number(guestSize);
//     phone = Number(phone);
//     originalPrice = Number(originalPrice); // Ensure originalPrice is a number
...
//       bookAt: new Date(bookAt),
//       payment: "pending",
//       price, // Price in NPR for Khalti
//       originalPrice, // Price in the user's selected currency
//       originalCurrency, // Currency selected by the user
//     });
...
//       purchase_order_id: bookingData._id.toString(),
//       purchase_order_name: tourName || tourData.title,
//       return_url: returnUrl.toString(), // Use the modified return_url with itemId
//       website_url,
//     });
