        ...
        <Container>
            <Row>
                ...
                <Col lg='3'>
                    ...
                    <ListGroup className="footer__quick-links">
                    <ListGroupItem className='ps-0 border-0 d-flex aligh-items-center gap-3'>
                    ...
                    <ListGroupItem className='ps-0 border-0 d-flex aligh-items-center gap-3'>
                                    ...
                                    <p className="mb-0">sonamsherpa2k6@gmail.com</p>
                    </ListGroupItem>
                    <ListGroupItem className='ps-0 border-0 d-flex aligh-items-center gap-3'>
                ...
                <Col lg='12' className="text-center pt-5">
                    <p className="copyright">Copyright {year}, design and develop by Sonam Sherpa. All right reserved.</p>
                </Col>
            </Row>
        </Container>
    </footer>
