...
//           // Check if photo exists and format it correctly
...
//         // Fixed API endpoint to fetch bookings
...
//       // Validate password - must have at least one capital letter and one number
...
//                     </div>
//                     <div className="password-requirements" style={{fontSize: "0.75rem", marginTop: "0.25rem", color: "var(--text-secondary)"}}>
//                       Username
//                     </div>
//                   </div>
//                   <div className="form-group">
...
//                       </button>
//                     </div>
//                     {passwordError && <div className="password-error" style={{color: "var(--error-color)", fontSize: "0.75rem", marginTop: "0.25rem"}}>{passwordError}</div>}
//                     <div className="password-requirements" style={{fontSize: "0.75rem", marginTop: "0.25rem", color: "var(--text-secondary)"}}>
...
//                                 View Details
//                               </button>
//                               {/* Only show cancel button for bookings that aren't already cancelled */}
//                               {booking.payment !== "cancelled" && (
//                                 <button 
...
//                   <li className="detail-item">💰 <strong>Total Amount</strong> <p>${selectedBooking.price}</p></li>
...
//               )}
//               {cancelSuccess && (
//                 <button className="close-dialog-button" onClick={handleCloseCancelDialog}>
//                   Close
//                 </button>
//               )}
//             </div>
...
//         const itinerariesRes = await fetch(`${BASE_URL}/itineraries/`, {
//           method: "GET",
//           headers: {
//             Authorization: `Bearer ${token}`,
//             "Content-Type": "application/json",
...
//                                 ? `${getCurrencySymbol(itinerary.originalCurrency)}${itinerary.originalBudget}`
//                                 : `${getCurrencySymbol(itinerary.currency)}${itinerary.budget}`}
//                             </div>
