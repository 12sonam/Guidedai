...
//               <Star 
//                 className={`w-4 h-4 ${starValue <= Math.floor(rating) ? 'fill-orange-400 text-orange-400' : 'text-gray-300'}`}
//               />
...
//         // Refresh the selected guide's data
//         if (selectedGuide) {
...
//             >
//               {/* Ribbon for featured guides (optional) */}
//               {guide.isFeatured && (
...
//                   <span className="guide-modal-rating-value">{selectedGuide.rating?.toFixed(1) || '0.0'}</span>
//                 </div>
